...
def generate_test_description():
    ...
    rviz2_config =  os.path.join(ament_index_python.get_package_prefix('converter'),
            'lib/converter/',
            'converter.rviz')
    #rviz2_config = os.path.join(ament_index_python.get_package_share_directory('converter'),'converter', 'converter_rviz2.rviz')
...
class TestProcessOutput(unittest.TestCase):
    ...
    def timer_callback(self):
        ...
        input_data_path = os.path.join(
            ament_index_python.get_package_prefix('converter'),
            'lib/converter/',
    ...
    def test_dut_output(self, dut, proc_output):
        ...
        sub = self.node.create_subscription(
            PointCloud2,
            '/bf_lidar/point_cloud_converter',
