...
PREPROCESSING::PREPROCESSING(const rclcpp::NodeOptions& options) : Node("lidar_preprocessing",options) 
{
  ...
  param_topic_pointcloud_in, 10, std::bind(&PREPROCESSING::topic_callback, this, _1));
  ...
  param_topic_velocity_in, 10, std::bind(&PREPROCESSING::velocity_callback, this, _1));

}
void PREPROCESSING::velocity_callback(const velocity_msg::msg::Num::SharedPtr vel)
{
  speed = vel->num;
}
void PREPROCESSING::topic_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg)
{
  ...
  pcl::PCLPointCloud2 cloud_ROI = adaptive_roi(downsampled, speed);
