...
def generate_test_description():
    ...
    rviz2_config =  os.path.join(ament_index_python.get_package_prefix('clustering'),
            'lib/clustering/',
            'clustering.rviz')
    #rviz2_config = os.path.join(ament_index_python.get_package_share_directory('clustering'),'clustering', 'clustering_rviz2.rviz')
...
class TestProcessOutput(unittest.TestCase):
    ...
    def timer_callback(self):
        ...
        input_data_path = os.path.join(
            ament_index_python.get_package_prefix('clustering'),
            'lib/clustering/',
    ...
    def test_dut_output(self, dut, proc_output):
        ...
        sub = self.node.create_subscription(
            PointCloud2,
            '/bf_lidar/point_cloud_clustering',
